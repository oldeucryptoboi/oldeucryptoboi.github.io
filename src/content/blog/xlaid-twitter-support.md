...
When I [shipped LAID](https://oldeucryptoboi.com/blog/laid-detecting-ai-on-linkedin/) a few weeks ago, it did one thing: detect AI-generated LinkedIn posts. It worked. But LinkedIn isn't the only platform drowning in synthetic text.
...
![X/LAID detecting AI on LinkedIn — dog-ear badges scoring posts in a live feed](/Users/oldeucryptoboi/Downloads/li.jpg)

---

### LinkedIn comments, too

While I was mapping DOM selectors, I added comment detection on LinkedIn. Comments load dynamically as you scroll, so the existing [`MutationObserver`](https://developer.mozilla.org/en-US/docs/Web/API/MutationObserver) already catches them. I just needed the selectors (`.comments-comment-item`, `.comments-comment-entity`) and the same 50-character minimum threshold used for tweets.
...
The fix: a corner-fold triangle at the top-right of each post, using [`clip-path: polygon`](https://developer.mozilla.org/en-US/docs/Web/CSS/clip-path). It looks like a turned-down page corner — hence "dog-ear." It sits in dead space that no platform uses for interactive elements, so there's nothing to collide with.
...
![X/LAID running on X/Twitter — dog-ear badges on tweets](/Users/oldeucryptoboi/Downloads/x.jpg)
...
**Try it:** Install [X/LAID from GitHub](https://github.com/oldeucryptoboi/linkedin-ai-detector), scroll your X feed, and see what lights up.

**Read the original:** [I Built a Chrome Extension That Detects AI-Generated LinkedIn Posts](https://oldeucryptoboi.com/blog/laid-detecting-ai-on-linkedin/)

**Full write-up on the blog:** [oldeucryptoboi.com/blog/xlaid-twitter-support](https://oldeucryptoboi.com/blog/xlaid-twitter-support/)
